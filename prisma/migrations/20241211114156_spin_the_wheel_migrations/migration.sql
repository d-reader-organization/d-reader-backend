...
-- CreateIndex
CREATE UNIQUE INDEX "Drop_rewardId_itemId_key" ON "Drop"("rewardId", "itemId");
...
-- AddForeignKey
ALTER TABLE "Drop" ADD CONSTRAINT "Drop_rewardId_fkey" FOREIGN KEY ("rewardId") REFERENCES "WheelReward"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
