...
export async function toCollectibleComicRarityStatsDto(
  input: CollectibleComicRarityStatsInput,
) {
  ...
  const collectibleComicRarityStatsDto = plainToInstance(
    CollectibleComicRarityStatsDto,
    plainCollectibleComicRarityStatsDtoDto,
  );
  return collectibleComicRarityStatsDto;
}

export const toCollectibleComicRarityStatsDtoArray = (
  inputs: CollectibleComicRarityStatsInput[],
) => {
